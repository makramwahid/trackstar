...
class IssueController extends Controller
{
	...
	public $layout='//layouts/column2';
        private $_project = null; //@var private property containing the associated Project model instance.
	/**
	...
	public function filters()
	{
		return array(
			...
			'postOnly + delete', // we only allow deletion via POST request
                        'projectContext + create', //'projectContext -update': call fiter only during all action but not during the edit
		);
	}
	...
	protected function performAjaxValidation($model)
	{
       ...
       // In-class defined filter method, configured for use in the above
        public function filterProjectContext($filterChain)
        {
            ...
            //method. It is called before the actionCreate() action method is run in order to ensure a proper project context
            //set the project identifier based on GET input request variables            
            if(isset($_GET['pid'])){
            ...
            $filterChain->run(); //just run the filter and allows execution of the action filters()
        }
}
